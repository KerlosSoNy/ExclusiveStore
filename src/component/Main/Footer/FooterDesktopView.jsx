...
export default function FooterDesktopView(){
    return(
        <div className="w-screen h-[440px] bg-black lg:flex md:flex hidden flex-col relative">
            <div className="flex flex-row text-white container gap-6 mx-auto justify-evenly p-4 pt-14">
                {/* Exclusive */}
                <div className="flex flex-col gap-4 lg:w-[15%] md:w-[18%] w-0">
                ...
                {/* Support */}
                <div className="flex flex-col gap-4 lg:w-[15%] md:w-[18%] w-0 relative">
                ...
                <div className="flex flex-col gap-4 lg:w-[15%] md:w-[18%] w-0">
                    ...
                    <div className="flex flex-row lg:justify-around md:justify-between justify-between text-2xl text-center my-3">
                        <a  href="/" className="flex flex-col justify-center border-[1px] border-[#3d3d3d] lg:p-2 md:p-1 p-1 rounded-lg lg:w-[49%] md:w-[49%] w-0 hover:text-red-500">
            ...
            <div className="flex flex-row w-screen text-[#3d3d3d] absolute bottom-0 ">
